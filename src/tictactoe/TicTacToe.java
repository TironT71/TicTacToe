...
/**
 * Aquest es un programa de un joc anomenat TicTacToe
 *
 * @author Horia Serban
 * @version 1.0
 * @since  13-02-2024
...
public class TicTacToe {
    ...
    /**
     * Aqesta es la clase main del joc
     * 
    ...
    /**
     * Aqui es decideix si s'secriu la "X" o el "0"
     * 
     * @param i
     * @return X o 0
     */
    ...
    /**
     * Aqui es crea la taula bidimensional que es una 3*3
     * 
     * @param x
     * @param y
     * @return El tamany de la taula
     */
    ...
    /**
     * Aqui es el tir del contrincant que es 100% random
     * 
     * @param taulerJoc 
     */
    ...
    public static void tirContrincant(int[][] taulerJoc){
        ...
        do {
            random_x = rand.nextInt(1,3);
            random_y = rand.nextInt(1,3);
    ...
    /**
     * Aqui es on farem el nostre tir posarem les caselles on volem tirar
     * 
     * @param taulerJoc 
     */
